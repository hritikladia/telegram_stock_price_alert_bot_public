...
1. User creates alerts via Telegram
2. Alerts are stored in Supabase
3. Market data streams from the broker API
4. Alert engine evaluates incoming ticks
5. Rule engine checks conditions
6. Telegram notification is sent
...
GitHub
[https://github.com/hritikladia](https://github.com/hritikladia)
